require_relative 'lib/jagger_plerosis_test/version'

Gem::Specification.new do |spec|
  spec.name          = "jagger_plerosis_test"
  spec.version       = JaggerPlerosisTest::VERSION
  spec.authors       = ["111"]
  spec.email         = ["1336098842@qq.com"]

  spec.summary       = %q{jagger_plerosis_test} 
  spec.description   = %q{jagger_plerosis_test test gem push} 
  spec.homepage      = "https://github.com/superjagger/jagger_plerosis_test" 
  spec.license       = "MIT"
  spec.required_ruby_version = Gem::Requirement.new(">= 2.3.0")

  spec.metadata["allowed_push_host"] = "https://rubygems.org" 

  spec.metadata["homepage_uri"] = "https://github.com/superjagger/jagger_plerosis_test" 
  spec.metadata["source_code_uri"] = "https://github.com/superjagger/jagger_plerosis_test.git" 
  spec.metadata["changelog_uri"] =  "https://github.com/superjagger/jagger_plerosis_test/blob/main/CHANGELOG.md" 
  ...
  spec.add_dependency "jagger_judicatory_test", "~> 0.1"
end
